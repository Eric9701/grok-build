...
pub(crate) enum VersionPolicyError {
    #[error(
        "Cannot install Atlas {target}: the minimum allowed version is {minimum}. \
         Run `atlas update` to install the latest allowed version."
    )]
