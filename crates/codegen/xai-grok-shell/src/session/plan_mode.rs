...
pub struct PlanModeTracker {
    ...
    /// `~/.atlas/sessions/<cwd>/<session_id>/plan.md`
...
impl PlanModeTracker {
    ...
    /// directory (e.g., `~/.atlas/sessions/<encoded-cwd>/<session-id>/`).
...
mod tests {
    ...
    /// Build a test TemplateRenderer with standard Atlas Build tool mappings.
