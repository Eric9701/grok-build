...
impl SessionActor {
    ...
    async fn handle_turn_input_inner(
        ...
        *self.doom_loop_turn_tally.lock() = Default::default();
        ...
        let mut report_prompt_text = text.clone();
        ...
        if prompt_block.is_some() {
            ...
            *self.tool_context.prompt_index.lock().await = current_prompt_index;
            ...
            report_prompt_text = user_message.clone();
        ...
        let turn_model_id_for_report = crate::agent::remote_config::catalog_id_for_task_report(
            &self.models_manager.models(),
            &turn_model_id,
        );
        let turn_model_routing_for_report = crate::agent::remote_config::routing_name_for_task_report(
            &self.models_manager.models(),
            &turn_model_id,
        );
