...
pub(crate) use resolution::{
    ...
    allowlist_matches_nothing, available_models, catalog_id_for_task_report, is_campaign_only_flip,
    resolve_catalog_key, resolve_default_model, resolve_model_catalog, routing_name_for_task_report,
...
#[cfg(test)]
pub(crate) use fetch::{build_prefetched_map, overlay_at_rest_secrets};
#[cfg(test)]
