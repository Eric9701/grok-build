//! `atlas du`: what the user's Atlas home uses on disk.
//! It creates no Atlas home, registry file, or schema.
...
#[command(
    after_help = "Lists every top-level directory in the Atlas home, largest first, then every \
