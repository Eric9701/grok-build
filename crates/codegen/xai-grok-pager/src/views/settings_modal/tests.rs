...
// -- Blank line between the "Tip · Ask Atlas…" docs footer and the keybinding hints --
//
...
fn docs_footer_tip_is_centered() {
    ...
    // SHORT is "Tip · Ask Atlas to change a setting" (35 cells); LONG is ~73 cells. width=40 lands in the SHORT band.
...
fn consent_chooser_drops_tip_and_reset() {
    ...
    assert!(
        text.contains("d reset") && text.contains("Ask Atlas"),
