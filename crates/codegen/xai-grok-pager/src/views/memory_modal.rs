...
fn empty_state_markdown(capture_enabled: bool, dream_enabled: bool) -> String {
    ...
    text.push_str(
        "\nAtlas Build remembers conventions, decisions, and project facts across sessions so you \
...
This session reports a reason this version of Atlas Build doesn't recognize; run `/memory on` \
