# Atlas Build User Guide

Learn how to install, configure, and extend Atlas Build, the terminal-based AI coding assistant from SpaceXAI.
...
Customize and extend Atlas Build.
...
Automate, script, and integrate Atlas Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `atlas -p`, output formats, CI/CD integration, and piping |
