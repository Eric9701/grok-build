...
Skills are reusable prompt packages that extend Atlas with task-specific instructions. They let you capture a repeatable procedure once, instead of re-explaining it each session.
