...
Fear not — your settings, rules, and skills come with you. Atlas Build
...
writes the items you selected into your `.atlas` config. Re-run it anytime.
...
Run **`atlas inspect`** in a repo to see every rules file, skill, and MCP
server Atlas picked up, tagged with where it came from. Each compat source
