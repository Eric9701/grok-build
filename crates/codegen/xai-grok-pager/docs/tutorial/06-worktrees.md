...
Want Atlas working on a feature while you (or another Atlas session) work on
...
- **From the shell:**
  ...
  ```bash
  atlas --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three Atlas sessions on the same repo simultaneously.
