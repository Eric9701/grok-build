...
mod tests {
    ...
    // Human-only tips are suppressed there, while Atlas path guidance in
    // `<user_guide>` stays in both modes because ACP / VS Code still need it.
    // The header switches between interactive and autonomous wording.
