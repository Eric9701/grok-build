 ...
 */
const URI_BRAND = Symbol.for("atlas.host.Uri");
...
export interface Host {
   ...
   * (e.g. `"atlas.voiceApiKey"`). VS Code: `workbench.action.openSettings`.
   */
  openSettings(section?: string): Thenable<void>;
  /**
   * Start the AFK Pilot / remote device-link flow. On VS Code this runs the
   * contributed `atlas.linkRemote` command; a desktop host implements linking
