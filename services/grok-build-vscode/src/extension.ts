 ...
 * Explorer, and `workbench.view.extension.atlasSidebar` never registers. The
...
export function activate(context: vscode.ExtensionContext): GrokExtensionApi {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand("atlas.open", async () => {
      ...
      // all — which is how `atlas.open` came to fail with "command not found".
    ...
    vscode.commands.registerCommand("atlas.moveView", async () => {
