# Atlas CLI over ACP — current field feedback

Feedback for the xAI team from a thin ACP client (`atlas agent stdio`, JSON-RPC over stdio). It
...
prompts vary by machine because grok merges several invisible policy sources — Atlas project grants,
