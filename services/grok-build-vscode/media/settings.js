...
(function (root) {
  ...
  const ROWS = [
    ...
    },
    {
      ...
      message: () => ({ type: "openSettings", section: "atlas.telemetry.enabled" }),
    },
    {
      id: "telemetryRemote",
      category: "general",
    ...
    },
    {
      ...
      kind: "text",
      placeholder: "atlas send",
      defaultValue: "atlas send",
      get: (s) => (s && typeof s.voiceSendPhrase === "string") ? s.voiceSendPhrase : "atlas send",
